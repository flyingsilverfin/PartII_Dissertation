...
*/
        ...
        let actions = {
            ...
            'd': () => this.deletePacketReceived(<CT.DeleteMessage>packet.b),
            'ui': () => this.undoInsertReceived(<CT.UndoMessage>packet.b),
            'ud': () => this.undoDeleteReceived(<CT.UndoMessage>packet.b),
            'ri': () => this.redoInsertReceived(<CT.UndoMessage>packet.b),
            'rd': () => this.redoDeleteReceived(<CT.UndoMessage>packet.b),
            'reqCRDT': () => {
